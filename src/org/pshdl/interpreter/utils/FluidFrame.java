...
public class FluidFrame {
	...
	public static enum Instruction {
		...
		// Memory
		pushAddIndex(1, 1, 0, "Pushes an additional index into the write stack for that memory", "memoryID"), //
		loadMultiplex(1, 1, 1, "Loads the index of that internal", "internal"), //
		;
